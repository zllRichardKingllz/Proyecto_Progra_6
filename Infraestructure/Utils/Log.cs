   ...
   pDbUpdateException.Message);
    ...
    private static string GetDetailsSQLException(SqlException pExcepcion)
    {
        ...
        for (int i = 0; i < pExcepcion.Errors.Count; i++)
        {
           ...
           pExcepcion.Errors[i].Number); msg.AppendFormat("\tLineNumber: {1}\n", i + 1,
 pExcepcion.Errors[i].LineNumber);
    ...
    private static string GetCustomErrorByNumber(SqlException pSqlExcepcion)
    {
        ...
        switch (pSqlExcepcion.Number)
        {
            ...
            case 156:
                ...
                break;
            case 207:
                msg = "Error un campo de la tabla NO existe"; break;
            ...
            case 4060: //Cannot open database requested in login '%.*ls'. Login fails.
                ...
                break;
            case 18452: //Login failed for user '%ls'. Reason: Not associated with a trusted SQL Server connection.msg = "Error especifique un usuario y password";
                break;
